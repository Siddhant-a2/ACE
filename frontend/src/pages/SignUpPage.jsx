...
// Icons used in the signup form UI
import { Eye, EyeOff, Lock, Mail, Loader2 } from "lucide-react";

// Authentication store (handles signup logic and loading state)
...
function SignUp() {
  ...
  /* ----------------------------------
     ...
     ---------------------------------- */
  const {
    userSignUp,     // Function to create a new user
    isSigningUp     // Loading state during signup request
  } = useAuth();
  ...
  const handleSubmit = (e) => {
    ...
    userSignUp(formData);   // Send signup data to backend
  ...
  return (
    // Page wrapper to center the signup card
